...
/* And even worse if your compiler has built-in bool types... -law */
...
#define bfd_set_section_vma(bfd, ptr, val) (((ptr)->vma = (ptr)->lma = (val)), ((ptr)->user_set_vma = (bool)true), true)
...
#define bfd_set_cacheable(abfd,bool) (((abfd)->cacheable = (bool) (bool)), true)

extern bool bfd_cache_close PARAMS ((bfd *abfd));
/* NB: This declaration should match the autogenerated one in libbfd.h.  */

extern bool bfd_record_phdr
  PARAMS ((bfd *, unsigned long, bool, flagword, bool, bfd_vma,
	   bool, bool, unsigned int, struct sec **));
...
bfd_vma         bfd_get_bits       PARAMS ((bfd_byte *, int, bool));
void            bfd_put_bits       PARAMS ((bfd_vma, bfd_byte *, int, bool));

...
extern bool bfd_mips_ecoff_create_embedded_relocs
...
extern bool bfd_elf32_record_link_assignment
  PARAMS ((bfd *, struct bfd_link_info *, const char *, bool));
...
extern struct bfd_link_needed_list *bfd_elf_get_runpath_list
  PARAMS ((bfd *, struct bfd_link_info *));
extern bool bfd_elf32_discard_info
  PARAMS ((bfd *, struct bfd_link_info *));
extern bool bfd_elf64_discard_info
  PARAMS ((bfd *, struct bfd_link_info *));
...
extern bool bfd_m68k_elf32_create_embedded_relocs
  PARAMS ((bfd *, struct bfd_link_info *, struct sec *, struct sec *,
	   char **));
extern bool bfd_mips_elf32_create_embedded_relocs
  PARAMS ((bfd *, struct bfd_link_info *, struct sec *, struct sec *,
	   char **));
...
extern bool bfd_i386linux_size_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *));
extern bool bfd_m68klinux_size_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *));
extern bool bfd_sparclinux_size_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *));
...
extern bool bfd_get_file_window
  PARAMS ((bfd *, file_ptr, bfd_size_type, bfd_window *, bool));
...
extern bool bfd_xcoff_size_dynamic_sections
  PARAMS ((bfd *, struct bfd_link_info *, const char *, const char *,
	   ...
	   int, bool, bool, struct sec **, bool));
extern bool bfd_xcoff_link_generate_rtinit
  PARAMS ((bfd *, const char *, const char *, bool));

/* XCOFF support routines for ar.  */
extern bool bfd_xcoff_ar_archive_set_magic PARAMS ((bfd *, char *));
...
extern bool bfd_m68k_coff_create_embedded_relocs
  PARAMS ((bfd *, struct bfd_link_info *, struct sec *, struct sec *,
	   char **));
...
extern bool bfd_arm_pe_allocate_interworking_sections
  PARAMS ((struct bfd_link_info *));

extern bool bfd_arm_pe_process_before_allocation
  PARAMS ((bfd *, struct bfd_link_info *, int));

extern bool bfd_arm_pe_get_bfd_for_interworking
  PARAMS ((bfd *, struct bfd_link_info *));
...
#define SEC_GROUP 0x80000000
  ...
  /* Some internal packed bool fields.  */
  ...
  /* End of internal packed bool fields.  */
...
CONCAT2 (NAME,_get_section_contents_in_window)
  ...
  bool  (*_bfd_get_section_contents_in_window)
...
CONCAT2 (NAME,_bfd_print_private_bfd_data) \
  ...
  bool  (*_bfd_merge_private_bfd_data) PARAMS ((bfd *, bfd *));
  ...
  /* Called to copy BFD private symbol data from one symbol
     to another.  */
  bool  (*_bfd_copy_private_symbol_data) PARAMS ((bfd *, asymbol *,
                                                     bfd *, asymbol *));
  /* Called to set private backend flags.  */
  bool  (*_bfd_set_private_flags) PARAMS ((bfd *, flagword));

  /* Called to print private BFD data.  */
  bool  (*_bfd_print_private_bfd_data) PARAMS ((bfd *, PTR));
...
#define bfd_get_symbol_info(b,p,e) BFD_SEND(b, _bfd_get_symbol_info, (b,p,e))
  bool  (*_bfd_is_local_label_name) PARAMS ((bfd *, const char *));

  alent *  (*_get_lineno) PARAMS ((bfd *, struct symbol_cache_entry *));
  bool  (*_bfd_find_nearest_line)
...
#define bfd_read_minisymbols(b, d, m, s) \
  ...
  long     (*_read_minisymbols) PARAMS ((bfd *, bool, PTR *,
                                         unsigned int *));
#define bfd_minisymbol_to_symbol(b, d, m, f) \
  BFD_SEND (b, _minisymbol_to_symbol, (b, d, m, f))
  asymbol *(*_minisymbol_to_symbol) PARAMS ((bfd *, bool, const PTR,
                                             asymbol *));
...
CONCAT2 (NAME,_bfd_discard_group)
  ...
  bfd_byte *(*_bfd_get_relocated_section_contents)
    PARAMS ((bfd *, struct bfd_link_info *, struct bfd_link_order *,
             bfd_byte *, bool, struct symbol_cache_entry **));

  bool  (*_bfd_relax_section)
    PARAMS ((bfd *, struct sec *, struct bfd_link_info *, bool *));
  ...
  bool  (*_bfd_link_split_section) PARAMS ((bfd *, struct sec *));

  /* Remove sections that are not referenced from the output.  */
  bool  (*_bfd_gc_sections) PARAMS ((bfd *, struct bfd_link_info *));

  /* Attempt to merge SEC_MERGE sections.  */
  bool  (*_bfd_merge_sections) PARAMS ((bfd *, struct bfd_link_info *));

  /* Discard members of a group.  */
  bool  (*_bfd_discard_group) PARAMS ((bfd *, struct sec *));
